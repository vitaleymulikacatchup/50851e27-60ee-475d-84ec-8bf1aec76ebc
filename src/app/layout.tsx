...
export const metadata: Metadata = {
  title: "Onana Coffee - Premium Coffee Experience",
  description: "Discover artisan coffee at Onana Coffee. Premium blends, expert baristas, and sustainable sourcing. Visit us for the perfect cup every time.",
  keywords: ["coffee shop", "premium coffee", "artisan coffee", "espresso", "cold brew", "sustainable coffee", "coffee beans"],
  openGraph: {
    title: "Onana Coffee - Premium Coffee Experience",
    description: "Discover artisan coffee at Onana Coffee. Premium blends, expert baristas, and sustainable sourcing.",
    siteName: "Onana Coffee",
    images: [
      {
        url: "https://images.pexels.com/photos/5198144/pexels-photo-5198144.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Onana Coffee shop interior"
      }
    ],
    type: "website"
  },
